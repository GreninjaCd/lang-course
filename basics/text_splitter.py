...
def recursive_splitter():
    ...
    chunks = splitter.split_text(SAMPLE_TEXT) # When we have actual documents we can use split_documents
...
def overlap_importance():
    ...
    print(f" Chunk 1 end: ...{chunks_with_no_overlap[0][-20:]}")
    print(f" Chunk 2 start: {chunks_with_no_overlap[1][:20]}...")
