...
def demo_contextual_compression():
    ...
    print("Extracts only query-relavant content from documents")
    print("=" * 60)
    ...
    compression_retriever = ContextualCompressionRetriever(
        base_compressor=compressor, base_retriever=vectorstore.as_retriever(search_kwargs={"k": 4})
    )
    ...
    print(f"\n--- With Compression (only relevant content) ---")
